...
Perlite is a web interface for the note taking app [Obsidian](https://obsidian.md). It's a selfhosted alternative for their cloud vault. I wanted to set it up to allow my classmates to see my notes, and also to check them on computers that aren't my own. 
...
ex. A Record - notes.soulsender.me > 11.22.33.44
